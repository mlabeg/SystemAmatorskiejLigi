...
namespace LigaAmatorska.Infrastructure.Migrations
{
    ...
    [Migration("20240601194325_mecz_update")]
    partial class mecz_update
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LigaAmatorska.Domain.Entities.Aktualnosci", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LigaAmatorska.Domain.Entities.Mecz", b =>
                {
                    ...
                    b.Property<int?>("DruzynaAId")
                        .HasColumnType("int");

                    b.Property<int?>("DruzynaBId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DruzynaAId");

                    b.HasIndex("DruzynaBId");
            ...
            modelBuilder.Entity("LigaAmatorska.Domain.Entities.Mecz", b =>
                {
                    b.HasOne("LigaAmatorska.Domain.Entities.Druzyna", "DruzynaA")
                        .WithMany()
                        .HasForeignKey("DruzynaAId");

                    b.HasOne("LigaAmatorska.Domain.Entities.Druzyna", "DruzynaB")
                        .WithMany()
                        .HasForeignKey("DruzynaBId");

                    b.Navigation("DruzynaA");

                    b.Navigation("DruzynaB");
                });
